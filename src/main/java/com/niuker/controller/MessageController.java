...
import com.niuker.service.MessageService;
...
private static final Logger logger = LoggerFactory.getLogger(MessageController.class);
	...
	public String getConversationList(Model model) {
		...
		for(Message message : conversationList) {
			...
			vo.set("count", messageService.getConversationCount(message.getConversationId()));
	...
	public String addComment(@RequestParam("toName") String toName,
		...
		try {
			...
			return WendaUtil.getJSONString(1, "faxinshibai");
		}
	}
}
